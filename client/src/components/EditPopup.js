            ...
            >
                <Fade in={props.open}>
                    <div className={classes.paper}>
                        <h2 id="transition-modal-title">Edit User: {props.data.name}</h2>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-evenly", width: 400, marginTop: 20 }}>
                            <Button variant="contained" color="primary" onClick={e => handleUpdate(e)}>Update</Button>
